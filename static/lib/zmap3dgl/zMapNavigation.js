(function(root, factory) {
    ...
    GmMap3D["viewerCesiumNavigationMixin"] = factory()
}
    ...
    !function(a, b) {
        ...
        function c(a, b) {
            ...
            var c;
            return i(b) ? (b.deep = b.deep || !1,
            b.fields = b.fields || Object.getOwnPropertyNames(a),
            b.lazy = b.lazy || !1,
            h(a, b.fields, b)) : (c = b || Object.getOwnPropertyNames(a),
            h(a, c, {})),
            a
        }
        function d(a) {
        ...
        function g(a, b, c) {
            function d(a, b) {
                return e ? b ? e(a) : e : Array.isArray(a) ? (e = w.observableArray(a),
                m(w, e),
                e) : e = w.observable(a)
            }
            if (w.isObservable(a))
    ...
    void function(a, b, c) {
        ...
        function g(a) {
            function b(b, e) {
                return e || 2 === arguments.length ? d.set(b, e) : (e = d.get(b),
                e === c && (e = a(b),
                d.set(b, e))),
                e
            }
        ...
        var h = Object.getOwnPropertyNames
          ...
          , p = function(g) {
            function h(b) {
                return this === a || null == this || this === h.prototype ? new h(b) : (p(this, new o),
                void r(this, b))
            }
            function i(a) {
                n(a);
                ...
                t.exports = function(e, t) {
                    ...
                    function r(e) {
                        ...
                        return e = e.replace(/<[^<>]*>?/gi, function(e) {
                            ...
                            if (t = e.match(i)) {
                                var m = t[1];
                                if (o = n(m.match(/src="([^"<>]*)"/i)[1]),
                                l = m.match(/alt="([^"<>]*)"/i),
                                l = l && "undefined" != typeof l[1] ? l[1] : "",
                                a = m.match(/title="([^"<>]*)"/i),
                                a = a && "undefined" != typeof a[1] ? a[1] : "",
                                o && /^https?:\/\//i.test(o))
                                    return "" !== c ? '<img src="' + o + '" alt="' + l + '" title="' + a + '" class="' + c + '">' : '<img src="' + o + '" alt="' + l + '" title="' + a + '">'
                            }
                            return u = d.indexOf("a"),
                            t = e.match(r),
                            t && (a = "undefined" != typeof t[2] ? t[2] : "",
                            o = n(t[1]),
                            o && /^(?:https?:\/\/|ftp:\/\/|mailto:|xmpp:)/i.test(o)) ? (p = !0,
                            h[u] += 1,
                            '<a href="' + o + '" title="' + a + '" target="_blank">') : (t = /<\/a>/i.test(e)) ? (p = !0,
                            h[u] -= 1,
                            h[u] < 0 && (g[u] = !0),
                            "</a>") : (t = e.match(/<(br|hr)\s?\/?>/i)) ? "<" + t[1].toLowerCase() + ">" : (t = e.match(/<(\/?)(b|blockquote|code|em|h[1-6]|li|ol(?: start="\d+")?|p|pre|s|sub|sup|strong|ul)>/i),
                            t && !/<\/ol start="\d+"/i.test(e) ? (p = !0,
                            u = d.indexOf(t[2].toLowerCase().split(" ")[0]),
                            "/" === t[1] ? h[u] -= 1 : h[u] += 1,
                            h[u] < 0 && (g[u] = !0),
                            "<" + t[1] + t[2].toLowerCase() + ">") : s === !0 ? "" : f(e))
                        })
                    }
                    function o(e) {
                        var t, n, o;
                        ...
                        for (a = 0; a < d.length; a++)
                            g[a] = !1;
                        for (p = !1,
                        n = 0; n < e.tokens.length; n++)
                            if ("html_block" === e.tokens[n].type && (e.tokens[n].content = r(e.tokens[n].content)),
                            "inline" === e.tokens[n].type)
                                for (o = e.tokens[n].children,
                                t = 0; t < o.length; t++)
                    ...
                    function i(e) {
                        function t(e, t) {
                            ...
                            r = RegExp("</" + t + ">", "g"),
                            u === !0 ? (e = e.replace(n, ""),
                            e = e.replace(r, "")) : (e = e.replace(n, function(e) {
                                return f(e)
                            }),
                            ...
                            for (r = 0; r < e.tokens.length; r++)
                                if ("html_block" !== e.tokens[r].type) {
                                    if ("inline" === e.tokens[r].type)
                                        ...
                                        a = 0; a < o.length; a++)
                                            "html_inline" === o[a].type && (o[a].content = n(o[a].content))
                                } else
                                    e.tokens[r].content = n(e.tokens[r].content)
                        }
                    }
                    var l = e.linkify
                      , f = e.utils.escapeHtml;
                    t = t ? t : {};
                    var a, s = "undefined" != typeof t.removeUnknown ? t.removeUnknown : !1, u = "undefined" != typeof t.removeUnbalanced ? t.removeUnbalanced : !1, c = "undefined" != typeof t.imageClass ? t.imageClass : "", p = !1, d = ["a", "b", "blockquote", "code", "em", "h1", "h2", "h3", "h4", "h5", "h6", "li", "ol", "p", "pre", "s", "sub", "sup", "strong", "ul"], h = new Array(d.length), g = new Array(d.length);
                    for (a = 0; a < d.length; a++)
                        h[a] = 0;
                    for (a = 0; a < d.length; a++)
                        g[a] = !1;
        ...
        return function r(e, t, n) {
            ...
            16: [function(e, r, t) {
                ...
                a.fence = function(e, r, t, n, s) {
                    ...
                    c < 0 ? l.push(["class", t.langPrefix + f]) : l[c] += " " + t.langPrefix + f,
                    u = {
                        attrs: l
                    },
            ...
            18: [function(e, r, t) {
                ...
                r.exports = function(e, r, t, s) {
                    ...
                    if (s)
                        return !0;
                    for (32 === e.src.charCodeAt(x) && x++,
                    u = e.blkIndent,
                    e.blkIndent = 0,
                    f = d = e.sCount[r] + x - (e.bMarks[r] + e.tShift[r]),
                    l = [e.bMarks[r]],
                    e.bMarks[r] = x; x < y && (m = e.src.charCodeAt(x),
                    n(m)); )
                        9 === m ? d += 4 - d % 4 : d++,
                        x++;
                    for (i = x >= y,
                    ...
                    o = r + 1; o < t && !(e.sCount[o] < u) && (x = e.bMarks[o] + e.tShift[o],
                    y = e.eMarks[o],
                    !(x >= y)); o++)
                        if (62 !== e.src.charCodeAt(x++)) {
                            if (i)
                            ...
                            l.push(e.bMarks[o]),
                            e.bMarks[o] = x; x < y && (m = e.src.charCodeAt(x),
                            n(m)); )
                                9 === m ? d += 4 - d % 4 : d++,
                                x++;
                            i = x >= y,
            ...
            25: [function(e, r, t) {
                ...
                r.exports = function(e, r, t, a) {
                    ...
                    z = e.md.block.ruler.getRules("list"); c < t; ) {
                        for (v = k,
                        x = e.eMarks[c],
                        l = u = e.sCount[c] + k - (e.bMarks[r] + e.tShift[r]); v < x && (b = e.src.charCodeAt(v),
                        i(b)); )
                            9 === b ? u += 4 - u % 4 : u++,
                            v++;
                        if (D = v,
                        ...
                        e.sCount[r] = u,
                        D >= x && e.isEmpty(r + 1) ? e.line = Math.min(e.line + 2, t) : e.md.block.tokenize(e, r, t, !0),
                        e.tight && !E || (I = !1),
            ...
            27: [function(e, r, t) {
                ...
                r.exports = function(e, r, t, a) {
                    var c, l, u, p, h, f, d, m, _, g, k, b, v, x, y, C = 0, A = e.bMarks[r] + e.tShift[r], w = e.eMarks[r], D = r + 1;
                    ...
                    for (p = e.lineMax,
                    x = e.md.block.ruler.getRules("reference"); D < p && !e.isEmpty(D); D++)
            ...
            44: [function(e, r, t) {
                ...
                r.exports = function(e, r) {
                    ...
                    p < 0)
                        return !1;
                    if (f = p + 1,
                    f < y && 40 === e.src.charCodeAt(f)) {
                        for (f++; f < y && (c = e.src.charCodeAt(f),
                        a(c) || 10 === c); f++)
                            ;
                        if (f >= y)
                            return !1;
                        ...
                        b = f; f < y && (c = e.src.charCodeAt(f),
                        a(c) || 10 === c); f++)
                            ;
                        if (m = o(e.src, f, e.posMax),
                        f < y && b !== f && m.ok)
                            for (_ = m.str,
                            f = m.pos; f < y && (c = e.src.charCodeAt(f),
                            a(c) || 10 === c); f++)
                                ;
                        else
                            _ = "";
                        ...
                        if ("undefined" == typeof e.env.references)
                            return !1;
                        if (f < y && 91 === e.src.charCodeAt(f) ? (b = f + 1,
                        f = n(e, f),
            ...
            52: [function(r, t, n) {
                (function(r) {
                    !function(s) {
                        ...
                        var v, x, y = 2147483647, C = 36, A = 1, w = 26, D = 38, q = 700, E = 72, S = 128, F = "-", z = /^xn--/, L = /[^\x20-\x7E]/, T = /[\x2E\u3002\uFF0E\uFF61]/g, R = {
                ...
                n.prototype.parse = function(e, r) {
                    ...
                    !_[k] && (c || k && !g[k])) {
                        ...
                        for (t = 0; t < h.length; t++)
                            ...
                            i !== -1 && (b === -1 || i < b) && (b = i);
                        var v, x;
                        for (x = b === -1 ? l.lastIndexOf("@") : l.lastIndexOf("@", b),
                        x !== -1 && (v = l.slice(0, x),
                        l = l.slice(x + 1),
                        this.auth = v),
                        b = -1,
    ...
    define("Core/registerKnockoutBindings", ["GmMap3D/Widgets/SvgPathBindingHandler", "KnockoutES5", "Core/KnockoutMarkdownBinding", "Core/KnockoutHammerBinding"], function(SvgPathBindingHandler, Knockout, KnockoutMarkdownBinding, KnockoutHammerBinding) {
        "use strict";
    ...
    define("Core/loadView", ["GmMap3D/Widgets/getElement", "KnockoutES5", "Core/createFragmentFromTemplate"], function(getElement, Knockout, createFragmentFromTemplate) {
        "use strict";
    ...
    define("ViewModels/DistanceLegendViewModel", ["GmMap3D/Core/defined", "GmMap3D/Core/DeveloperError", "GmMap3D/Core/EllipsoidGeodesic", "GmMap3D/Core/Cartesian2", "GmMap3D/Core/getTimestamp", "GmMap3D/Core/EventHelper", "KnockoutES5", "Core/loadView", "leaflet"], function(defined, DeveloperError, EllipsoidGeodesic, Cartesian2, getTimestamp, EventHelper, Knockout, loadView, leaflet) {
        "use strict";
    ...
    define("ViewModels/UserInterfaceControl", ["GmMap3D/Core/defined", "GmMap3D/Core/defineProperties", "GmMap3D/Core/DeveloperError", "KnockoutES5"], function(defined, defineProperties, DeveloperError, Knockout) {
        "use strict";
    ...
    define("ViewModels/ResetViewNavigationControl", ["GmMap3D/Core/defined", "GmMap3D/Scene/Camera", "GmMap3D/Core/Rectangle", "GmMap3D/Core/Cartographic", "ViewModels/NavigationControl", "SvgPaths/svgReset"], function(defined, Camera, Rectangle, Cartographic, NavigationControl, svgReset) {
        "use strict";
        var ResetViewNavigationControl = function(terria) {
            ...
            this.lonlat   = new GmMap3D.Cartesian3(113.23333,23.16667,1167385.56);
        };
        ResetViewNavigationControl.prototype = Object.create(NavigationControl.prototype);
        
        ResetViewNavigationControl.prototype.setLocate = function(lon, lat, height)
         {
            this.lonlat = new GmMap3D.Cartesian3(lon, lat, height ? height : 1167385.56);
            return this.lonlat;
         }
         
        ResetViewNavigationControl.prototype.getLocate = function()
         {
            return [this.lonlat.x, this.lonlat.y, this.lonlat.z];
         }         
                ...
                if (this.terria.options.defaultResetView) {
                    if (this.terria.options.defaultResetView && this.terria.options.defaultResetView instanceof Cartographic) {
                        ...
                        try {
                            ...
                            console.log("GmMap3D-navigation/ResetViewNavigationControl:   options.defaultResetView GmMap3D rectangle is  invalid!")
                        }
                    }
                } else if (typeof camera.flyHome === "function") {
                    //camera.flyHome(1)
                    var carPos    = this.lonlat;    
                    var ellipsoid = scene.globe.ellipsoid; // 获取地球球体对象                      
                    var pos       = GmMap3D.Cartesian3.fromDegrees(carPos.x, carPos.y, carPos.z, ellipsoid); 
                    camera.setView({
                        destination: pos,
                        orientation: {
                            heading : GmMap3D.Math.toRadians(0), 
                            pitch : GmMap3D.Math.toRadians(-90),   
                            roll : 0.0
                        }
                    })
                } else {
    ...
    define("Core/Utils", ["GmMap3D/Core/defined", "GmMap3D/Core/Ray", "GmMap3D/Core/Cartesian3", "GmMap3D/Core/Cartographic", "GmMap3D/Core/ReferenceFrame", "GmMap3D/Scene/SceneMode"], function(defined, Ray, Cartesian3, Cartographic, ReferenceFrame, SceneMode) {
        "use strict";
        var Utils = {};
    ...
    define("ViewModels/ZoomNavigationControl", ["GmMap3D/Core/defined", "GmMap3D/Core/Ray", "GmMap3D/Core/IntersectionTests", "GmMap3D/Core/Cartesian3", "GmMap3D/Scene/SceneMode", "ViewModels/NavigationControl", "Core/Utils"], function(defined, Ray, IntersectionTests, Cartesian3, SceneMode, NavigationControl, Utils) {
        "use strict";
    ...
    define("ViewModels/NavigationViewModel", ["GmMap3D/Core/defined", "GmMap3D/Core/Math", "GmMap3D/Core/getTimestamp", "GmMap3D/Core/EventHelper", "GmMap3D/Core/Transforms", "GmMap3D/Scene/SceneMode", "GmMap3D/Core/Cartesian2", "GmMap3D/Core/Cartesian3", "GmMap3D/Core/Matrix4", "GmMap3D/Core/BoundingSphere", "GmMap3D/Core/HeadingPitchRange", "KnockoutES5", "Core/loadView", "ViewModels/ResetViewNavigationControl", "ViewModels/ZoomNavigationControl", "SvgPaths/svgCompassOuterRing", "SvgPaths/svgCompassGyro", "SvgPaths/svgCompassRotationMarker", "Core/Utils"], function(defined, CesiumMath, getTimestamp, EventHelper, Transforms, SceneMode, Cartesian2, Cartesian3, Matrix4, BoundingSphere, HeadingPitchRange, Knockout, loadView, ResetViewNavigationControl, ZoomNavigationControl, svgCompassOuterRing, svgCompassGyro, svgCompassRotationMarker, Utils) {
        "use strict";
    ...
    define("CesiumNavigation", ["GmMap3D/Core/defined", "GmMap3D/Core/defineProperties", "GmMap3D/Core/Event", "KnockoutES5", "Core/registerKnockoutBindings", "ViewModels/DistanceLegendViewModel", "ViewModels/NavigationViewModel"], function(defined, defineProperties, CesiumEvent, Knockout, registerKnockoutBindings, DistanceLegendViewModel, NavigationViewModel) {
        "use strict";
    ...
    define("viewerCesiumNavigationMixin", ["GmMap3D/Core/defined", "GmMap3D/Core/defineProperties", "GmMap3D/Core/DeveloperError", "CesiumNavigation", "dummy/require-less/less/dummy"], function(defined, defineProperties, DeveloperError, CesiumNavigation) {
        "use strict";
    ...
    define("GmMap3D/Core/defined", function() {
        return GmMap3D["defined"]
    });
    define("GmMap3D/Core/defineProperties", function() {
        return GmMap3D["defineProperties"]
    });
    define("GmMap3D/Core/defaultValue", function() {
        return GmMap3D["defaultValue"]
    });
    define("GmMap3D/Core/Event", function() {
        return GmMap3D["Event"]
    });
    define("GmMap3D/Widgets/getElement", function() {
        return GmMap3D["getElement"]
    });
    define("GmMap3D/Widgets/SvgPathBindingHandler", function() {
        return GmMap3D["SvgPathBindingHandler"]
    });
    define("GmMap3D/Core/Ray", function() {
        return GmMap3D["Ray"]
    });
    define("GmMap3D/Core/Cartesian3", function() {
        return GmMap3D["Cartesian3"]
    });
    define("GmMap3D/Core/Cartographic", function() {
        return GmMap3D["Cartographic"]
    });
    define("GmMap3D/Core/ReferenceFrame", function() {
        return GmMap3D["ReferenceFrame"]
    });
    define("GmMap3D/Scene/SceneMode", function() {
        return GmMap3D["SceneMode"]
    });
    define("GmMap3D/Core/DeveloperError", function() {
        return GmMap3D["DeveloperError"]
    });
    define("GmMap3D/Core/EllipsoidGeodesic", function() {
        return GmMap3D["EllipsoidGeodesic"]
    });
    define("GmMap3D/Core/Cartesian2", function() {
        return GmMap3D["Cartesian2"]
    });
    define("GmMap3D/Core/getTimestamp", function() {
        return GmMap3D["getTimestamp"]
    });
    define("GmMap3D/Core/EventHelper", function() {
        return GmMap3D["EventHelper"]
    });
    define("GmMap3D/Core/Math", function() {
        return GmMap3D["Math"]
    });
    define("GmMap3D/Core/Transforms", function() {
        return GmMap3D["Transforms"]
    });
    define("GmMap3D/Core/Matrix4", function() {
        return GmMap3D["Matrix4"]
    });
    define("GmMap3D/Core/BoundingSphere", function() {
        return GmMap3D["BoundingSphere"]
    });
    define("GmMap3D/Core/HeadingPitchRange", function() {
        return GmMap3D["HeadingPitchRange"]
    });
    define("GmMap3D/Scene/Camera", function() {
        return GmMap3D["Camera"]
    });
    define("GmMap3D/Core/Rectangle", function() {
        return GmMap3D["Rectangle"]
    });
    define("GmMap3D/Core/IntersectionTests", function() {
        return GmMap3D["IntersectionTests"]
    });
